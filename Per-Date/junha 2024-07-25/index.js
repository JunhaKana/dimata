...
/* 
 ...
 3. buat kondisi menggunakan if dimana jika i jika di bagi dengan 3 dan hasil nya 0 dan jika i dibagi dengan 5 dan hasilnya 0 maka console log LIMA TIGA
...
6. lalu buat return di setiap golongan, supaya bisa di tampilkan nanti di console log
7. buat const hasil dan masukan function yang tadi dibuat beserta value yang mau di masukan
...
const hasill = bodyMassIndex(77, 1.75);
console.log(hasill);
...
const hasil = antiGanjil(array);
console.log("bilangangenap : ${hasil}");
// console.log()
...
5. masukan parameter nya dengan kalimat string dan spasi, supaya bisa di pisah per kata
*/
